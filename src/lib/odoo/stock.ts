...
const LIST_FIELDS = ["id", "name", "default_code", "categ_id", "qty_available", "virtual_available"]
...
function shapeProduct(raw: OdooProductTemplate, imageBase64?: string | false): StockProduct {
  return {
    ...
    available: raw.virtual_available,
  }
}

// TODO: filter by user warehouseId once field name confirmed (Open Items §11.1)
export async function getStockProducts(sessionId: string): Promise<StockProduct[]> {
